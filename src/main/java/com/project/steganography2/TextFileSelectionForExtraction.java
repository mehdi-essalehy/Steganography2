...
public class TextFileSelectionForExtraction extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_text_file_selection_for_extraction);
    }

    public void sendMessage(View view) {
        try {
            // create intent to move data from SecondActivity to ThirdActivity
            Intent intent = new Intent(this, TextExtraction.class);
